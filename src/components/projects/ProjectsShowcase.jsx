...
const CATEGORY_STYLES = {
  ...
  Website: {
    accentGrad: "from-[#BA203B] via-[#E23E5B] to-[#101218]",
    glowShadow: "hover:shadow-[0_16px_32px_-8px_rgba(186,32,59,0.20)]",
    borderColor: "hover:border-[#BA203B]",
    iconBg: "bg-[#FCEBEF]",
    iconBorder: "border-[#F5CAD3]",
    iconColor: "text-[#BA203B]",
    badgeBg: "bg-[#FAF8F9]",
    badgeText: "text-[#101218]",
    badgeBorder: "border-[#E9E2E5]",
  },
  Hardware: {
    accentGrad: "from-[#1B7352] to-[#2D9F75]",
    glowShadow: "hover:shadow-[0_16px_32px_-8px_rgba(45,159,117,0.22)]",
    borderColor: "hover:border-[#2D9F75]",
    iconBg: "bg-[#E8F7F1]",
    iconBorder: "border-[#C6EFE0]",
    iconColor: "text-[#1B7352]",
    badgeBg: "bg-[#E8F7F1]",
    badgeText: "text-[#1B7352]",
    badgeBorder: "border-[#C6EFE0]",
  },
  "Data Analysis": {
    accentGrad: "from-[#831124] to-[#BA203B]",
    glowShadow: "hover:shadow-[0_16px_32px_-8px_rgba(186,32,59,0.22)]",
    borderColor: "hover:border-[#BA203B]",
    iconBg: "bg-[#FCEBEF]",
    iconBorder: "border-[#F5CAD3]",
  ...
  Other: {
    accentGrad: "from-[#101218] to-[#BA203B]",
    glowShadow: "hover:shadow-[0_16px_32px_-8px_rgba(186,32,59,0.20)]",
    borderColor: "hover:border-[#BA203B]",
    iconBg: "bg-[#FCEBEF]",
    iconBorder: "border-[#F5CAD3]",
